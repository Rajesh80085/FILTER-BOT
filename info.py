...
API_ID = int(environ.get('API_ID', '24058958'))
API_HASH = environ.get('API_HASH', '92cda122030e37e3bf03305a1d6726a6')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/e29aa852-4be2-4dca-8ef4-ba9be6744820.jpeg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6329750853').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002641292373'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002612941771').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002577190422') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4741479898')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rajesh0143225:8wsTYizJaS6plvUa@cluster0.yvltika.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "rajesh0143225")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+x5wjvyk0y_00NTg1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+ssQGjpA7MoozOTk1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+8lTyv2JXFwQ1NzZl') # Support Chat Link Without https:// or @
